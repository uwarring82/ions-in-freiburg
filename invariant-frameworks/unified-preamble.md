---
description: Constitutional Architecture for Epistemic and Ontological Frameworks
...
**License:** CC BY 4.0\
\
**Status:** Constitutional meta-document\
**Scope:** Governs relationship between all invariant frameworks
{% endhint %}
...
This preamble establishes the **constitutional architecture** governing the relationship between frameworks that describe _what exists_ (ontological/discovery frameworks) and frameworks that constrain _what humans may legitimately claim to know_ (epistemic frameworks).
...
Epistemic frameworks constrain human claims **about** ontological matters.\
Ontological frameworks are **not constrained by** how humans learn.
...
A phenomenon may exist without any human knowing it.\
A human claim about a phenomenon may be epistemically illegitimate even if the phenomenon exists.
...
The Guardian stance holds veto power over merge violations.\
Citation: _Violation of Clarity or Ethics_ (Category Error subtype).
...
│   Subject to DEEP partition audit           │
└─────────────────────────────────────────────┘
                    │
...
The metaphysics of this constraint is not specified. The architecture requires only that _something_ makes some claims wrong.
...
> This document operates under the Unified Preamble (v1.0), Resolution R-O/L-01.\
> Stack position: \[ONTOLOGICAL / EPISTEMIC / CLAIMS / TOOLS]\
> Coupling status: \[SILOED / REFERENCES: list]
