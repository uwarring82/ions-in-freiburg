...
_As a new member, you'll join a team dedicated to scientific discoveries. Here's how we aim to collaborate, the tools we use, and you may begin to identify your role in the team._
...
_As a team member, you'll engage in all project aspects, from experiments to manuscript contributions. Your expertise is valuable in our collaborative effort to advance science. Welcome aboard!_

## Guidelines for Scientific Integrity

We adhere to strict guidelines to maintain honesty in science:

* **DFG White Paper**: ["Safeguarding Good Scientific Practice"](http://www.dfg.de/en/research_funding/principles_dfg_funding/good_scientific_practice/index.html)
* **University Regulations**: [University of Freiburg's Academic Integrity](http://www.uni-freiburg.de/forschung-en/redlichkeit_in_der_wissenschaft?set_language=en)
...
* **Journal Guidelines**: Refer to journals like [Physical Review](https://journals.aps.org/prl/authors) for manuscript preparation.
* **Writing Guides**:
  * M. van der Perk's [A Guide for Scientific Writing](https://students.uu.nl/sites/default/files/ge0-aw-guide-for-scientific-writing-2016.pdf)

## Keeping Track of Literature

* **Reference Managers**: Use [Mendeley](https://www.mendeley.com/) or [Zotero](https://www.zotero.org/) to organize literature and generate citations.
* **VPN Access**: Set up a [VPN connection](https://www.rz.uni-freiburg.de/services-en/netztel-en/vpn/vpn-einleitung-en?set_language=en) to access journals from home.
* **Literature Databases**: Use [ISI Web of Science](https://apps.webofknowledge.com/) for comprehensive searches.
...
* **GitLab**: Learn via [GitLab Tutorials](https://docs.gitlab.com/ee/tutorials/).
* **Mattermost**: Explore the [Mattermost Documentation](https://docs.mattermost.com/).
* **Overleaf**: Start with [Overleaf Tutorials](https://www.overleaf.com/learn/latex/Tutorials).
...
_We look forward to your contributions. Let's achieve great things together!_
