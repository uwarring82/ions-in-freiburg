...
**For administrators (25 min)**: Read "The Heroism Trap" + "Trust Is Infrastructure" + "Towards a Research Agenda" + "The Responsibility We Owe"

**For researchers (45 min)**: Full essay + references + consider the research questions in section 8
...
A well-designed system should require **minimal maintenance energy** so that the limited free energy instructors _do_ have can be invested in what cannot be automated: presence, clarity, dialogue, mentorship.
...
2. **Tiered AI Disclosure** — Simple form:
   * ☐ No AI assistance used
   * ☐ AI used for brainstorming/outlining (ideas are mine, organization assisted)
   * ☐ AI used for drafting (I wrote with AI, then revised extensively)
   * ☐ AI used for editing (grammar, clarity, structure feedback)
   * ☐ Other: \[describe]
...
4. **Process-Weighted Assessment** — Value thinking trajectory (drafts, revision, reasoning) as much as polished final product. Makes deception harder and less attractive.
5. **Clear Proportionate Consequences** — _After_ the non-punitive window:
   * Second instance: Required reflection + revision
   * Deliberate deception: Academic integrity review
   * Systematic violation: Course-level consequences
6. **Academic Integrity Panel** — Escalated cases reviewed by trained 3-person faculty panel (not single instructor), ensuring procedural fairness and consistency.
...
### 7. What Systems Cannot (and Should Not) Do
...
### 8. Towards a European Research Agenda
...
### 10. The Responsibility We Actually Owe
...
* **Student Guide**: "Understanding the Systems You're In" — Recognition tools and navigation strategies
* **Instructor Handbook**: "Low-Friction Teaching Interventions" — Practical implementations requiring minimal additional energy
* **Policy Brief**: "Trust Infrastructure as Investment" — Cost-benefit analysis for administrators
* **Intervention Library**: Detailed how-to guides for small, medium, and large-scale changes

**Visual materials in development:**

* Concept maps (Respect-Trust-Responsibility feedback loops)
* Infographics (The Heroism Trap, Safe Harbor Protocol, Hidden Curriculum as noise)
